      ...
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="bg-gray-50 rounded-2xl md:rounded-3xl p-6 md:p-12">
          <div className="text-center mb-8 md:mb-12">
            <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">Frequently Asked Questions</h3>
            <p className="text-lg md:text-xl text-gray-600">Everything you need to know about our pricing</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 max-w-4xl mx-auto">
            <div>
              <h4 className="font-semibold text-gray-900 mb-2 text-sm md:text-base">When is commission charged?</h4>
              <p className="text-gray-600 text-xs md:text-sm">
                Commission is only charged when a barter deal is successfully completed and both parties confirm the
                exchange.
              </p>
            </div>
            <div>
              <h4 className="font-semibold text-gray-900 mb-2 text-sm md:text-base">Can I change plans anytime?</h4>
              <p className="text-gray-600 text-xs md:text-sm">
                Yes! You can upgrade, downgrade, or cancel your plan at any time. Changes take effect at the next
                billing cycle.
              </p>
            </div>
            <div>
              <h4 className="font-semibold text-gray-900 mb-2 text-sm md:text-base">Is there a setup fee?</h4>
              <p className="text-gray-600 text-xs md:text-sm">
                No setup fees, no hidden costs. You only pay the monthly subscription and commission on successful
                deals.
              </p>
            </div>
            <div>
              <h4 className="font-semibold text-gray-900 mb-2 text-sm md:text-base">What if I exceed my deal limit?</h4>
              <p className="text-gray-600 text-xs md:text-sm">
                You can upgrade your plan or pay a small overage fee. We'll notify you before you reach your limit.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="text-center mt-12 md:mt-16">
          <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-4">Ready to start bartering?</h3>
